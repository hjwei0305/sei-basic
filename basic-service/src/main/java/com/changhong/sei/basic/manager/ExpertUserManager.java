 ...
 */
@Component
public class ExpertUserManager extends BaseEntityManager<ExpertUser> {
    @Autowired
    ...
    @Autowired
    private ExpertUserProfessionalDomainManager expertUserProfessionalDomainManager;
    ...
    public OperateResult save(ExpertUserVo expertUserVo) {
        ...
        if (isNew) {
            ...
            //为新增的专家用户分配领域
            expertUserProfessionalDomainManager.saveRelations(expertUser.getId(), expertUserVo.getProfessionalDomainIds());
            ...
            TransactionAspectSupport.currentTransactionStatus().flush();
            //修改专家的领域
            expertUserProfessionalDomainManager.saveRelations(expertUserFromDb.getId(), expertUserVo.getProfessionalDomainIds());
            //返回
    ...
    public PageResult<ExpertUserVo> findVoByPage(Search searchConfig) {
        ...
        for (ExpertUser expertUser : resultRows) {
            ...
            //设置领域
            List<ProfessionalDomain> professionalDomainList = expertUserProfessionalDomainManager.getChildrenFromParentId(expertUser.getId());
